...
const url =
  "https://api.cricapi.com/v1/cricScore?apikey=398e42ac-b41d-4dc6-80e0-07b64160da58";
const firstMatchDateTimeStr = "5:00:00 AM";
const secondMatchDateTimeStr = "8:30:00 AM";
  ...
  .then((data) => {
    ...
    if (data.status === "success") {
      ...
      for (let index = 0; index < dataLength; index++) {
        ...
        const timeString = dateTimeString.toLocaleTimeString();
        

        if (
          firstMatchDateTimeStr === timeString || secondMatchDateTimeStr === timeString) {
        //   console.log(apiData[index]);
          ...
          imgFirstTeamFlag.setAttribute(
            "src",
            `https://cdorg.b-cdn.net/flags/generic/${countryShortNameArray[0]}.svg`
          );

          imgSecondTeamFlag.setAttribute(
            "src",
            `https://cdorg.b-cdn.net/flags/generic/${countryShortNameArray[1]}.svg`
          );
          ...
          for (const iterator of teamsNameArray) {
            ...
            const tShorthandName = teamShortNameStr.slice(
              1,
              teamShortNameStr.length - 1
            );
